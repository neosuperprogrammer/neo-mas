...
public class TasClient {
	...
	public TasClient(String ip, int port, int idleTime, XMLConfiguration protocolConfig) {
		this.ip = ip;
		this.port = port;
	...
	public TasClient(String ip, int port, int idleTime, XMLConfiguration protocolConfig, TasClientSslConfig tasClientSslConfig) {
