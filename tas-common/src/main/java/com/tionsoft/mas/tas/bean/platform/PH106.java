...
public final class PH106 extends PlatformHeader {
	
	
	private static final long serialVersionUID = 539096284934851848L;

	public PH106() {
		super();
		setValue(VERSION, "PHV106");
	}
