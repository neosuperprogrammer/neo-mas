...
public class TasBackgroundDBLoggingFilter implements Filter {
	...
	public void doFilter(Object message, FilterChain chain) throws PlatformException {
		...
		printPlatformHeader(tasRequest.getPlatformHeader(),inoutType);
		
		chain.doFilter(tMessage);
		
	}
	
	private void printPlatformHeader(PlatformHeader platformHeader,String inoutType) {
		...
		if(phv.equals("PHV101")) {
			...
			//PHV101
			log(phv,  appId ,msId, sessionId,  tranId, serviceId, imei, msisdn, bodyType, statusCode, headerLength, bodyLength, inoutType);
			...
			//PHV102
			log(phv,  appId ,msId, sessionId,  tranId, serviceId, imei, msisdn, wifiMac, modelNo, ispName, osType, osVer, uuid, bodyType,statusCode, headerLength, bodyLength, inoutType);

		}else{////PHV100
			log(phv,  appId ,msId, sessionId,  bodyType, statusCode, headerLength, bodyLength, inoutType);
		}	
	...
	//PHV100
    public void log(String phv,  String appId ,String msId, long sessionId, short bodyType, short statusCode, int headerLength, int bodyLength, String inoutType){
    	log(phv, appId, msId, sessionId, 0, 0, "", "", bodyType, statusCode, headerLength, bodyLength, inoutType);
    }

    //PHV101
    public void log(String phv,  String appId ,String msId, long sessionId,  long tranId, 
    		int serviceId, String imei, String msisdn, short bodyType, short statusCode, int headerLength, int bodyLength, String inoutType){
    	log(phv, appId, msId, sessionId, tranId, serviceId, imei, msisdn,"","","","","","", bodyType, statusCode, headerLength, bodyLength, inoutType);
    }
	...
	private void log(String phv, String appId, String msId, long sessionId,
					...
					int headerLength, int bodyLength, String inoutType) 
	{
